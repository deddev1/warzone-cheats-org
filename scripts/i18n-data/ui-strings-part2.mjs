...
export const uiStringsPart2 = {
	ar: {
		...
		footer: { explore: 'استكشف', help: 'المساعدة والقانون', tagline: 'ESP وwallhack ورadar وAimbot غير مكتشف لـ Warzone — الدفع عبر Zadeyo.' },
		images: {
	...
	ja: {
		...
		footer: { explore: '探索', help: 'ヘルプと法務', tagline: 'Warzone向けundetected ESP、wallhack、radar、Aimbot — Zadeyoで購入。' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	ko: {
		...
		footer: { explore: '탐색', help: '도움말 및 법적', tagline: 'Warzone용 undetected ESP, wallhack, radar, Aimbot — Zadeyo 결제.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	zh: {
		...
		footer: { explore: '探索', help: '帮助与法律', tagline: 'Warzone undetected ESP、wallhack、radar与Aimbot — 通过Zadeyo结账。' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	hi: {
		...
		footer: { explore: 'एक्सप्लोर', help: 'सहायता और कानूनी', tagline: 'Warzone के लिए undetected ESP, wallhack, radar और Aimbot — Zadeyo checkout।' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	id: {
		...
		footer: { explore: 'Jelajahi', help: 'Bantuan & legal', tagline: 'ESP, wallhack, radar, dan Aimbot undetected untuk Warzone — checkout via Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	th: {
		...
		footer: { explore: 'สำรวจ', help: 'ช่วยเหลือและกฎหมาย', tagline: 'ESP, wallhack, radar และ Aimbot ไม่ถูกตรวจจับสำหรับ Warzone — ชำระผ่าน Zadeyo' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	vi: {
		...
		footer: { explore: 'Khám phá', help: 'Trợ giúp & pháp lý', tagline: 'ESP, wallhack, radar và Aimbot undetected cho Warzone — thanh toán qua Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	uk: {
		...
		footer: { explore: 'Огляд', help: 'Допомога та право', tagline: 'Undetected ESP, wallhack, radar і Aimbot для Warzone — оплата через Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	cs: {
		...
		footer: { explore: 'Prozkoumat', help: 'Nápověda a právo', tagline: 'Undetected ESP, wallhack, radar a Aimbot pro Warzone — checkout přes Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	ro: {
		...
		footer: { explore: 'Explorează', help: 'Ajutor și legal', tagline: 'ESP, wallhack, radar și Aimbot undetected pentru Warzone — checkout via Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
	...
	sv: {
		...
		footer: { explore: 'Utforska', help: 'Hjälp & juridik', tagline: 'Undetected ESP, wallhack, radar och Aimbot för Warzone — checkout via Zadeyo.' },
		images: {
		hero: "Warzone Cheats hero — ESP and aimbot overlay in Call of Duty: Warzone",
		espWallhack: "Wallhack outlines showing enemy operators and squads through walls",
		aimbotCombat: "Soft aim assist overlay during a Call of Duty: Warzone match",
