...
> = {
	en: {
		blogTitle: 'Warzone Cheats Blog | Warzone Guides',
		blogDescription:
			'Call of Duty: Warzone guides — match tips, ESP, aimbot notes, loot routes, and Ricochet update coverage. English blog at warzonecheats.org/blog/.',
		blogH1: 'Warzone Cheats Intel',
		blogIntro:
			'Short Call of Duty: Warzone guides for BR and Resurgence-style modes. Pair these tips with the Warzone Cheats product pages when you need ESP, soft aim, or radar.',
		readMore: 'Read guide',
		published: 'Published',
		updated: 'Updated',
